...
def render_footer():
    ...
    with c2:
        st.markdown(
            ...
            <div class="footer-link-item">Fake News Detection</div>
            <div class="footer-link-item">Deepfake Detection</div>
            <div class="footer-link-item">Analytics Dashboard</div>
            <div class="footer-link-item">About</div>
            <div class="footer-link-item">Meet the Team</div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with c3:
        st.markdown(
            ...
            <div class="footer-link-item">Python 3.10+</div>
            <div class="footer-link-item">Streamlit</div>
            <div class="footer-link-item">HuggingFace</div>
            <div class="footer-link-item">Plotly</div>
            <div class="footer-link-item">Pillow</div>
            """,
            unsafe_allow_html=True,
        )
